...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
       ...
       _lable2 = [UILabel new];
        ...
        _lable3 = [UILabel new];
        _lable3.textColor              = [UIColor darkGrayColor];
        _lable3.font                   = [UIFont systemFontOfSize:screen_width / 24];
        _lable3.textAlignment          = NSTextAlignmentLeft;
        [self addSubview:_lable3];
        [_lable3 makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(_lable2.right).offset(10);
            make.height.equalTo(CELLHEIFGT);
            make.top.equalTo(0);
        }];
