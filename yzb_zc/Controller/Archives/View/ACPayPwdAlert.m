...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    [self.pwdInputView makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(20);
        make.top.equalTo(topLine.bottom).offset(15);
        make.width.equalTo(inputH*self.length);
        make.height.equalTo(inputH);
    }];
    [bottomLine makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(0);
        make.top.equalTo(self.pwdInputView.bottom).offset(15);
        make.width.equalTo(width);
        make.height.equalTo(0.5);
    }];
    [bottomVLine makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo((width-0.5)*0.5);
    ...
    ///确定按钮的位置
    [self.completeBtn makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(cancelBtn.right);
        make.top.equalTo(bottomLine.bottom);
        make.width.equalTo(width / 2);
        make.height.equalTo(btnH);
    }];
